...
_TEMPLATES: dict[str, SceneTemplate] = {
    ...
    "english": SceneTemplate(
        scene_id="english",
        name="英语",
        icon="🔤",
        color="#3b82f6",
        description="每日背单词打卡，内置四级高频词库，认识/模糊/忘记分级反馈",
        task_type="word",
        default_target=20.0,
        unit="词",
        steps=["看释义", "记例句", "自测默写"],
        difficulty_curve="稳定目标，每日词量渐进温和递增",
        sample_prompts=[
            "30天每天背20个英语单词",
            "66天冲刺四级核心词汇",
            "每天积累10个高频词",
    ...
    "poem": SceneTemplate(
        ...
        icon="📜",
        color="#b45309",
        description="每日背诵一首诗词，内置唐诗精选，朗读-理解-背诵-默写",
        task_type="recite",
        default_target=1.0,
        unit="首",
        steps=["朗读全诗", "理解大意", "背诵全诗", "默写检验"],
        difficulty_curve="稳定目标，每天一首不增量",
        sample_prompts=[
            "30天背30首唐诗",
            "每天背诵一首古诗",
            "21天诗词积累",
    ...
    "pomodoro": SceneTemplate(
        scene_id="pomodoro",
        name="番茄",
        icon="🍅",
        color="#ef4444",
        description="番茄工作法专注打卡，25分钟专注+5分钟休息，内置倒计时器",
        task_type="timer",
        default_target=25.0,
        unit="分钟",
        steps=["设定任务", "专注25分钟", "休息5分钟"],
        difficulty_curve="稳定目标，每天1-4个番茄循环",
        sample_prompts=[
            "每天4个番茄钟专注学习",
            "25分钟专注力训练",
            "用番茄工作法戒掉拖延",
